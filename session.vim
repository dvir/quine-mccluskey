...
silent only
cd ~/projects/quine-mccluskey
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 qmc.cpp
badd +16 src/binary.cpp
badd +3 include/binary.h
badd +0 src/term.cpp
...
let s:l = 174 - ((41 * winheight(0) + 22) / 45)
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 221 - ((10 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
221
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 16 - ((11 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 22 - ((17 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
